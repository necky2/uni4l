const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuUni4l",
      en: "About application uuUni4l",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuUni4l.",
      en: "You can buy your own uuUni4l.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuUni4l.",
      en: "You don't have rights to initialize this uuUni4l.",
    },
  },
